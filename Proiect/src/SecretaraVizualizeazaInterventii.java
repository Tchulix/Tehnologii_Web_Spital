...
/**
 * Servlet implementation class SecretaraVizualizeazaInterventii
 */
@WebServlet("/secretara_vizualizeaza_interventii")
public class SecretaraVizualizeazaInterventii extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SecretaraVizualizeazaInterventii() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/secretara_vizualizeaza_interventii.jsp");
