...
/**
 * Servlet implementation class AdministratorVerificaBilantCabinet
 */
@WebServlet("/administrator_verifica_bilant_cabinet")
public class AdministratorVerificaBilantCabinet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdministratorVerificaBilantCabinet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
				...
				{RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/administrator_verifica_bilant_cabinet.jsp");
