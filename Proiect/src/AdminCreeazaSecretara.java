...
/**
 * Servlet implementation class AdminCreeazaSecretara
 */
@WebServlet("/admin_creeaza_secretara")
public class AdminCreeazaSecretara extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminCreeazaSecretara() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/admin_creeaza_secretara.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	    	...
	    	+ "-" + Integer.parseInt(request.getParameter("zi")) + "', 'secretara', '" +
