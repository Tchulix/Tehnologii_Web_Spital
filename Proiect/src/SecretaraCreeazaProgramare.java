...
/**
 * Servlet implementation class SecretaraCreeazaProgramare
 */
@WebServlet("/secretara_creeaza_programare")
public class SecretaraCreeazaProgramare extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SecretaraCreeazaProgramare() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
				...
				{RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/secretara_creeaza_programare.jsp");
