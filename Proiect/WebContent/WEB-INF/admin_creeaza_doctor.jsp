...
<li class="active"><a href="${pageContext.request.contextPath}/admin_creeaza_doctor">
  Adauga Cont Doctor
</a></li>
...
<form method="POST" action="${pageContext.request.contextPath}/admin_creeaza_doctor">
         ...
         <table border="0">
          ...
          <tr>
          	<td>Specialitate</td>
          	<td><input type="text" name="specialitate" value="${user.specialitate}"></td>
          </tr>
          ...
          <tr>
            ...
            <tr>
               <td colspan ="2">
                  ...
                  <a href="${pageContext.request.contextPath}/">Creeaza</a>
               </td>
            </tr>  
